...
do
	...
	Library.GUI = Create("ScreenGui", {Name = game:GetService "HttpService":GenerateGUID(false), Parent = i:IsStudio() and j.PlayerGui or game:GetService "CoreGui".RobloxGui.Modules})
	...
	function Library:CreateWindow(Options)
		...
		Library.AddSignal(SearchbarInput:GetPropertyChangedSignal("Text"), function()
			...
			for l,v in next, Page[Library.SelectTab].Data do
				...
				local title = (v.SearchTitle or v.Title()):lower()
		...
		function t:AddTab(Title)
			...
			function h:AddButton(l)
				...
				table.insert(Page[h.Tab].Data, {Container = s.Frame, SearchTitle = l.SearchTitle, Title = function()
					return s.Title
				end})
			...
			function h:AddSlider(n, l)
				...
				table.insert(Page[h.Tab].Data, {Container = d.Frame, SearchTitle = l.SearchTitle, Title = function()
					return d.Title
				end})
